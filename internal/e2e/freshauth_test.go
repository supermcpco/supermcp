...
func TestFreshAuthGuardsSensitiveOperations(t *testing.T) {
	...
	for _, c := range []struct{ method, path string }{
		...
		{http.MethodPost, "/api/v1/dlp/policies/none/revisions/1/restore"},
		{http.MethodPost, "/api/v1/approval-policies/none/revisions/1/restore"},
		{http.MethodPost, "/api/v1/idps/none/revisions/1/restore"},
